...
/// The [TapeDecoder] class offers a quality of life tool to allow decoding and visual printing of the contents of a [CommandBuffer].
/// To decode a CommandBuffer the following command can be used:
/// ```dart
/// TapeDecoder(commandBuffer.bytes()).decode();
/// ```
/// This class uses the [Logger] class for advanced logging.
class TapeDecoder {
  Uint8List tape;
  ...
  /// Decodes the Tape assigned to the TapeDecoder. It translates the operations into its corresponding parts
  /// and uses the [Logger] class to print out a visual representation of the commands in order of execution.
  /// The following computational tree obtained by calling `printGraph`on a [GPUTensor]:
  /// ```dart
  ...
  /// ```
  /// This was used to create a CommandBuffer. Decoding resulted in the following structure:
  /// ```dart
