...
void main() {
  ...
  Tensor<Matrix> attentionInput = generateMatrix(seqLen, dModel);

  runBenchmark<Matrix, Matrix>('SingleHeadAttention (Seq: 64, dModel: 128)', attention, attentionInput, iterations);
